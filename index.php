...
<html lang="zxx">
   <head>
      <title>Welcome to Prabhu Gym - Singansadra, Bangalore</title>
      <meta charset="UTF-8">
      <meta name="title" content="Welcome to Prabhu Gym - Singansadra, Bangalore">
      <meta name="keywords" content="Gym, Gym Offers, Singansadra Gym, Bangalore Gym">
      <meta name="description" content="We are the No1 1 Gym in Singasandra and we are giving monthlu ayeba opandkbksdks">
      <meta name="author" content="Prabhu, Ram, Dandapani, PES College Final Year Students - Batch 1297, Project Nam38407">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form id="signin" name="signin" method="POST" >
                     <p>First Name: <input class="box" type="text" name="first" id="first" placeholder="Enter your firstname" required></p>
                     <p>Last Name: <input class="box" type="text" name="last" id="last" placeholder="Enter your lastname" required></p>
                     <p>Password: <input class="box" type="password" name="pass" id="pass" placeholder="Enter your password" required></p>
                     <!--  <p>Address: <textarea class="box" rows="6" cols="100" name="addr" id="addr" placeholder="Enter your address" required></textarea></p> -->
                     <button name="press" id="press" class="cent blink" onclick="success()"><span>Submit &raquo;<span></button>
                  </form>
               </div>
      ...
      <div id="signup" class="modal fade" role="dialog">
         <div class="modal-dialog">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form id="signup" name="signin" method="POST" >
                     <p>First Name: <input class="box" type="text" name="first" id="first" placeholder="Enter your firstname" required></p>
                     <p>Last Name: <input class="box" type="text" name="last" id="last" placeholder="Enter your lastname" required></p>
                     <p>Password: <input class="box" type="password" name="pass" id="pass" placeholder="Enter your password" required></p>
                     <!--  <p>Address: <textarea class="box" rows="6" cols="100" name="addr" id="addr" placeholder="Enter your address" required></textarea></p> -->
                     <p>Gender:  Male<input type="radio" name="gender" value="male"> Female<input type="radio" name="gender" value="female"></p>
                     <p>Highest Qualification: <input class="box" type="text" name="high" id="high"></p>
                     <button name="press" id="press" class="cent blink" onclick="success()"><span>Submit &raquo;<span></button>
                  </form>
               </div>
               <div class="modal-footer">
      ...
      <header class="header-section">
         <div class="container-fluid">
            ...
            <div class="top-social">
               <!-- Modal button-->
               <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#signin">Sign In</button>   <!-- this button is very useful for modal re dont ever forget this -->
            ...
            <div class="single-hero-item set-bg" data-setbg="img/hero-slider/hero-1.jpg">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="hero-text">
                           <h2>Welcome To <?php $username ?></h2>
                           <h1><i class="fa fa-futbol-o" aria-hidden="true"></i> Ninja Gym <i class="fa fa-futbol-o" aria-hidden="true"></i> </h1>
            ...
            <div class="row">
               <div class="col-lg-6">
                  <div class="about-text">
                     <h2>WELCOME TO NINJA-GYM</h2>
                     <p class="short-details">Ninja-Gym is a cutting-edge functional fitness system that can help
                        everyday men.
                     </p>
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="classes-item set-bg" data-setbg="img/classes/class-1.jpg">
                     ...
                     <!-- <p>Sufferers around the globe will be happy to hear that there are sleep apnea remedies.</p>
                        -->  <a href="#" class="primary-btn class-btn">Book It</a>
                  </div>
               </div>
               <div class="col-lg-3 col-sm-6">
               ...
               <div class="col-lg-5">
                  <div class="footer-logo-item">
                     ...
                     <p>Despite growth of the Internet over the past seven years, the use of toll-free phone numbers
                        in television advertising continues.
                     </p>
